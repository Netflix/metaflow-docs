...
Metaflow R is a human-friendly R library that helps scientists and engineers build and manage real-life data science projects. Metaflow was originally developed at Netflix to boost productivity of data scientists who work on a wide variety of projects from classical statistics to state-of-the-art deep learning.
...
If you are eager to give Metaflow a try, head to the [tutorials](https://github.com/Netflix/metaflow-docs/tree/b90f7b9c89a00a9c344df9d41bfd39b23a674bd8/getting-started/tutorials/README.md). If you want to learn about the background of Metaflow in more detail, keep on reading.
